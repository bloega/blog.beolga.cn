setInterval(() => {
    ...
    let create_time = Math.round(new Date('2022/09/15 00:00:00').getTime() / 1000); //在此行修改建站时间
...
document.getElementById("page-name").innerText = document.title.split(" | Beolga")[0];
